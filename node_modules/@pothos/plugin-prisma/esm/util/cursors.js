...
export function formatCursor(fields) {
    return (value) => {
...
export function parseRawCursor(cursor) {
...
export function wrapConnectionResult(results, args, take, cursor, totalCount) {
    var ref, ref1;
