...
export declare type YogaServerInstance<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>, TRootValue> = YogaServer<TServerContext, TUserContext, TRootValue> & (WindowOrWorkerGlobalScope['fetch'] | ((request: Request, serverContext?: TServerContext) => Promise<Response>) | ((context: {
    request: Request;
}) => Promise<Response>));
